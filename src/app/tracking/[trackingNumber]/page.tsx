...
// const TrackingPage = () => {
//     const { trackingNumber } = useParams(); // Getting the trackingNumber from the URL params
...
//                 setTrackingData(data); // Set tracking data from response
//             } catch (err: any) {
...
//             {trackingData ? (
//                 <pre className="bg-gray-100 p-4 rounded-md">{JSON.stringify(trackingData, null, 2)}</pre>
//             ) : (
